    ...
    <>
      <div className="xl:max-w-[1500px]  md:max-w-[920px] mx-auto mt-20 px-3">
        <div className="flex flex-col gap-2  items-center">
          <h1 className="playfair-semibold bg-gradient-to-b from-[#E0048B] to-[#83268E] bg-clip-text text-transparent text-2xl sm:text-3xl md:text-4xl lg:text-4xl">Organizing Committee</h1>
        ...
        <div className="p-[2px] rounded-2xl bg-gradient-to-b from-[#E0048B] to-[#83268E]">
          <div className="bg-white p-5 rounded-xl overflow-hidden">
            <div className='text-center'>
              <p className="playfair-semibold text-xl sm:text-2xl md:text-3xl lg:text-3xl">Meet the team behind <span className="bg-gradient-to-b from-[#E0048B] to-[#83268E] bg-clip-text text-transparent">ICASTAI </span>2025</p>
            </div>
            <div className="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 max-w-[70rem] gap-10 mt-10 mx-auto">
              <div className="border border-gray-400 p-4 rounded-lg">
                <div className="grid lg:grid-cols-2 items-center gap-10">
                  <div className='flex flex-col gap-4'>
                    <p className="playfair-semibold text-xl sm:text-2xl md:text-2xl lg:text-2xl bg-gradient-to-b from-[#E0048B] to-[#83268E] bg-clip-text text-transparent">Chairman</p>
              ...
              <div className="border border-gray-400 p-4 rounded-lg">
                <div className="grid lg:grid-cols-2 items-center gap-10">
                  <div className='flex flex-col gap-4'>
                    <p className="playfair-semibold text-xl sm:text-2xl md:text-2xl lg:text-2xl bg-gradient-to-b from-[#E0048B] to-[#83268E] bg-clip-text text-transparent">Convenors</p>
                    <div className="flex flex-col gap-2">
                      <p><span className="inter-medium text-md text-gray-900">Name :</span> <span className='text-gray-600 inter-regular'>Dr John Smith</span></p>
                      <p><span className="inter-medium text-md text-gray-900">Position :</span> <span className='text-gray-600 inter-regular'>Principal</span></p>
                      <p><span className="inter-medium text-md text-gray-900">Qualification :</span> <span className='text-gray-600 inter-regular'>M.E., Ph.D.,</span></p>
              ...
              <div className="border border-gray-400 p-4 rounded-lg">
                <div className="grid lg:grid-cols-2 items-center gap-10">
                  <div className='flex flex-col gap-4'>
                    <p className="playfair-semibold text-xl sm:text-2xl md:text-2xl lg:text-2xl bg-gradient-to-b from-[#E0048B] to-[#83268E] bg-clip-text text-transparent">Advisory Committee</p>
                    <div className="flex flex-col gap-2">
                      <p><span className="inter-medium text-md text-gray-900">Name :</span> <span className='text-gray-600 inter-regular'>Dr John Smith</span></p>
                      <p><span className="inter-medium text-md text-gray-900">Position :</span> <span className='text-gray-600 inter-regular'>Principal</span></p>
                      <p><span className="inter-medium text-md text-gray-900">Qualification :</span> <span className='text-gray-600 inter-regular'>M.E., Ph.D.,</span></p>
              ...
              <div className="border border-gray-400 p-4 rounded-lg">
                <div className="grid lg:grid-cols-2 items-center gap-10">
                  <div className='flex flex-col gap-4'>
                    <p className="playfair-semibold text-xl sm:text-2xl md:text-2xl lg:text-2xl bg-gradient-to-b from-[#E0048B] to-[#83268E] bg-clip-text text-transparent">Coordinators</p>
                    <div className="flex flex-col gap-2">
                      <p><span className="inter-medium text-md text-gray-900">Name :</span> <span className='text-gray-600 inter-regular'>Dr John Smith</span></p>
                      <p><span className="inter-medium text-md text-gray-900">Position :</span> <span className='text-gray-600 inter-regular'>Principal</span></p>
                      <p><span className="inter-medium text-md text-gray-900">Qualification :</span> <span className='text-gray-600 inter-regular'>M.E., Ph.D.,</span></p>
              ...
              <div className="border border-gray-400 p-4 rounded-lg">
                <div className="grid lg:grid-cols-2 items-center gap-10">
                  <div className='flex flex-col gap-4'>
                    <p className="playfair-semibold text-xl sm:text-2xl md:text-2xl lg:text-2xl bg-gradient-to-b from-[#E0048B] to-[#83268E] bg-clip-text text-transparent">Members</p>
                    <div className="flex flex-col gap-2">
                      <p><span className="inter-medium text-md text-gray-900">Name :</span> <span className='text-gray-600 inter-regular'>Dr John Smith</span></p>
                      <p><span className="inter-medium text-md text-gray-900">Position :</span> <span className='text-gray-600 inter-regular'>Principal</span></p>
                      <p><span className="inter-medium text-md text-gray-900">Qualification :</span> <span className='text-gray-600 inter-regular'>M.E., Ph.D.,</span></p>
