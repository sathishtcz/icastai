      ...
      <div className="xl:max-w-[1500px]  md:max-w-[920px] mx-auto mt-20 px-3 lg:block hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-15 gap-5">
          ...
          <div className="flex flex-col justify-center ">
            ...
            <div className="lg:mb-10 mb-[12px]">
          ...
          <div className="bg-[#F6D5EA] rounded-md p-2">
            <div className="flex flex-row items-center gap-2">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="inter-medium sm:text-base md:text-lg lg:text-[16px] text-gray-700">TamilNadu, Chennai</p>
              </div>
            </div>
          </div>
          <div className="bg-[#F6D5EA] p-2 rounded-md">
            <div className="flex flex-row items-center gap-2">
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="inter-medium sm:text-base md:text-lg lg:text-[16px] text-gray-700">28th to 30th August, 2025</p>
              </div>
            </div>
          </div>
          <div className="bg-[#F6D5EA] p-2 rounded-md">
